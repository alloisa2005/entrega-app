    ...
    <div className='relative w-full'>
      ...
      <div className='contenedor py-24 grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='border rounded-md text-center w-full flex flex-col items-center gap-3 p-2 justify-center shadow-md'>
          <GiPriceTag size={70} className='text-blue-600' />
          <h2 className='text-2xl font-bold text-blue-600'>Grandes Ofertas</h2>
        ...
        <div className='border rounded-md text-center w-full flex flex-col items-center gap-3 p-2 justify-center shadow-md'>
          <AiOutlineStar size={70} className='text-blue-600' />
          <h2 className='text-2xl font-bold text-blue-600'>Novedades Exclusivas</h2>
        ...
        <div className='border rounded-md text-center w-full flex flex-col items-center gap-3 p-2 justify-center shadow-md'>
          <FaTruckFast size={70} className='text-blue-600' />
          <h2 className='text-2xl font-bold text-blue-600'>Envíos Rápidos</h2>
