  ...
  const columns = [
    {
      header: "Foto",
      cell: info => {        
        return <div className="w-[35px] h-[35px] rounded-full overflow-hidden ml-2 -mr-4">
          <Image src={info.row.original.image} alt={info.row.original.nombre} width={70} height={50} className='w-full h-full object-cover' />
        </div>
      }
    },
    {
    ...
    },    
    {
      ...
      cell: info => {   
        ...
        <Link href={`/admin/editJuego/${userId}`}>
